...
#define FILENAME "comp_times.csv"
...
int main() {
    ...
    fprintf(gnuplot, "set title 'Compile times over 1000 runs'\n");
    fprintf(gnuplot, "set xlabel 'Run Number'\n");
    fprintf(gnuplot, "set ylabel 'Compile time (seconds)'\n");
    fprintf(gnuplot, "plot '-' using 1:2 with lines title 'Compile time'\n");
